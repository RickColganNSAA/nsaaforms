...
{	
	...
	if ( !empty($_FILES) )
	{
		...
		if ( citgf_moveuploadedfile( $file['tmp_name'], $uniqueFileName ) )
		{
			...
			$sql="UPDATE joentries SET filename2='$useFileName' WHERE id='$entryid'";
...
<script type="text/javascript">
	...
	var uploadUrl = "simpleupload2.php"; //"https://secure.nsaahome.org/nsaaforms/jo/simpleupload2.php"; //Note: & symbol should be encoded to %26 for query string values. Ex: http://www.somesite.com/uploader.aspx?field1=value1%26field2=value2
        if (!document.all) {
            uploadUrl = "../simpleupload2.php";
        }
