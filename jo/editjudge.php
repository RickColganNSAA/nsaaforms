...
if ($_POST['save']) {
    ...
    //JUDGE INFO
    $sql = "UPDATE jojudges SET first='$first',last='$last',email='$email',password='$password',address='$address',city='$city',state='$state',zip='$zip' WHERE id='$judgeid'";
...
echo "<form method='post' action='editjudge.php'>";
...
if ($_POST['save']) {
    echo "<div class='alert'>Your changes have been saved. <a href=\"judges.php?session=$session\" class=\"small\">Return to Journalism Judges List</a></div>";
}
