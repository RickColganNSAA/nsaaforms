...
if($sport=='bbg') $sport='sog';

if(!$sport) $sport='sob';
$sportname=GetActivityName($sport);
if($sport=='sob') $sport2="so_b";
else $sport2="so_g";
...
while($row=mysql_fetch_array($result))
{
   ...
   $schs[$ix]=$row[school];
   $links[$ix]="<a href=\"view_".$sport2.".php?school_ch=$row[school]&session=$session&makepdf=1\" target=\"_blank\">Preview PDF</a>";
