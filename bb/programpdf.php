...
while($row0=mysql_fetch_array($result0))
{
   ...
   $mascot=$row2[mascot]; $enrollment=($sport=='bbb')?$row2[boysenrollment]:$row2[girlsenrollment];
	//COACH
   ...
   $html="<table cellspacing=\"0\" cellpadding=\"0\"><tr align=\"center\">
        ...
        <td><b>HT</b></td><td><b>PTS</b></td><td><b>AVG</b></td><td><b>REB</b></td><td><b>AVG</b></td><td><b>AST</b></td><td><b>STL</b></td><td><b>BLK</b></td></tr>";
	...
	*/
     	...
     	if(count($pos)>2)
	{
       ...
       $html.="<tr align=\"center\"><td width=\"15\">$row[jersey_lt]&nbsp;</td><td width=\"90\" align=\"left\">$first $last</td><td width=\"$smallw\">$grade</td><td>$row[position]</td><td>$row[height]</td><td>$row[total_pts]</td><td>$row[pt_avg]</td><td>$row[total_rb]</td><td>$row[reb_avg]</td><td>$row[total_assists]</td><td>$row[total_steals]</td><td>$row[total_blocks]</td></tr>";
       $count++;
   }
   //TESTING:
	/*
