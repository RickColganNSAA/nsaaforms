...
/* NO LONGER LONG FORM JUST SWITCH DISTRICT TO STATE
...
<form method=post action="submit_bb_g.php"  enctype="multipart/form-data">
...
echo GetSchoolName($sid,'bbg')." $mascot";
   ?>
   </td>
   </tr>
   <tr align=left>
...
if($level==1)
{
	  ...
	  $sql_coop="SELECT * FROM bbgschool WHERE mainsch='$row_id[id]' AND (othersch1!='' OR othersch2!='' OR othersch3!='') ";
