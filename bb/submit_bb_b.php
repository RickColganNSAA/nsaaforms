...
//HISTORICAL INFO
$sql="UPDATE bbbschool SET tripstostate='$tripstostate',mostrecent='$mostrecent',championships='$championships',runnerup='$runnerup' WHERE sid='$sid'";
$result=mysql_query($sql);
if(mysql_error()) { echo mysql_error(); exit(); }
  ...
  if(!empty($_FILES["imageUpload"]["name"])){
	...
	$sql="UPDATE bbbschool SET filename='$image' WHERE sid='$sid'";
    $result=mysql_query($sql);	 	
} 
