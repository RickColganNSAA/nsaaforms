...
else if($submit=="Submit Test Answers")
{
      ...
      if($percent>79 )
   {
      ...
      $To=$row_pp['email'];
	  $ToName=$row_pp['first'].' '.$row_pp['last'];
      $date=date("M d, Y",$datetaken);
	  $title = 'NSAA Registered Play Production Judge';
      $email_text="Hi $ToName\r\n\r\n";
      $email_text.="Congratulations, you have completed the requirements to be an NSAA Registered Play Production Judge\r\n\r\nThank You!"; 
      $attm=array();
      if ($pp_requirements==1)
