...
echo "<table width=90%>";
echo "<caption><b>Fast Pitch Softball Rules Examination - Part I</b></caption>";
...
$sql0="SELECT category,place FROM sbtest_categ ORDER BY place";
...
$sql="SELECT question,place,answer FROM sbtest WHERE category='$categid' ORDER BY place";
$result=mysql_query($sql);
$ix=0;
