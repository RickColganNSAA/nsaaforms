...
if($sample==1 && $level==1)
{
   ...
   $type="District"; $class="A"; $district="1";
   $schools="Omaha North,Omaha Burke,Omaha Skutt Catholic,Omaha Marian";
   $distid=2;
}
...
if($error==1)
{
   echo "<tr align=left><td><font style=\"color:red\"><b>If you accept this contract, you MUST enter the Director's name and e-mail, as well as the site for the contest.";
...
if($accept=='y' && !$submit)
{
   ...
   if($confirm=='y')
   {
      ...
      if($level!=1)
      {
         echo "<br>Please <a class=small href=\"hostslots.php?session=$session&ad=1&sport=$sport&distid=$distid\">Click Here</a> to enter the dates and times for this contest.";
      }
   }
...
echo "<table>";
echo "<tr align=left><td><b>$type $class-$district $sportname</b></td></tr>";
echo "<tr align=left><td><b>Schools Tentatively Assigned:</b></td></tr>";
echo "<tr align=center><td><table><tr align=left><td>$schools</td></tr></table></td></tr>";
if($accept=='y')
{
...
{
   echo "<tr align=left><td><br><br><input type=radio name=accept value='y'>&nbsp;&nbsp;&nbsp;<b>We accept the above agreement to host the $type $class-$district $sportname Contest</b>";
   if($edit==1)
   ...
   echo "<i>If you accept, you must complete ALL of the fields below:</i><br>";
   ...
   {
      $temp=split("-",$days[0]);
      echo "<tr align=left><td><b>Date:</b>&nbsp;".date("F j, Y",mktime(0,0,0,$temp[1],$temp[2],$temp[0]))."</td></tr>"; 
   }
   echo "<tr align=left valign=top><td width=125><b>Starting Time:</b><br>(Example: 9:30am)</td>";
   echo "<td><input type=text name=\"time\" size=10 class=tiny onchange=\"this.form['accept'][0].checked=1;\"></td></tr>";
