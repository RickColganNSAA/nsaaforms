...
if($edit==1 && $savechanges)
{
   ...
   $sql="UPDATE bbgcontracttext SET text1='$text1',text2='$text2',text3='$text3' WHERE district='2'";
   $result=mysql_query($sql);
}

//get contract text
$dist=2;
$sql="SELECT * FROM bbgcontracttext WHERE district='$dist'";
$result=mysql_query($sql);
$row=mysql_fetch_array($result);
...
echo "<br>";
echo "<form method=post action=\"hostcontract_bbg.php\">";
...
if($edit==1)
   echo "<br><a class=small href=\"hostcontract_bbg.php?session=$session&sample=1\">Preview this Contract</a>";
else if($sample==1)
   echO "<br><a class=small href=\"hostcontract_bbg.php?session=$session&edit=1\">Edit this Contract</a>";
echo "</td></tr>";
...
if($accept=='y')
{
   ...
   echo "</td>";
   echo "<td><table border=1 bordercolor=#000000 cellspacing=0 cellpadding=2><tr align=center><td><b>Game</b></td><td><b>Date</b></td><td><b>Time</b></td></tr>";
