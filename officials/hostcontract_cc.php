...
'2'";
   ...
   if($dates!="0000-00-00")
   {
      $sql="UPDATE ccdistricts SET dates='$dates' WHERE type='District'";
      $result=mysql_query($sql);
   }
}
...
echo "<br>";
echo "<form method=post action=\"hostcontract_cc.php\">";
...
if($edit==1)
   echo "<br><a class=small href=\"hostcontract_cc.php?session=$session&sample=1\">Preview this Contract</a>";else
   echo "<br><a class=small href=\"hostcontract_cc.php?session=$session&edit=1\">Edit this Contract</a>";
echo "</td></tr>";
...
echo "<tr align=left><td colspan=2><b>$class-$district Boys & Girls</b></td></tr>";
