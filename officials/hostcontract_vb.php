...
if($sport=='sb') $gamecount=($teamcount*2)-1;
...
else if($level!=1) $dates="editable";
$schools=$row[schools];
...
echo "<br>";
echo "<form method=post action=\"hostcontract_vb.php\">";
...
echo "<tr align=left><td><b>DATE:</b></td><td><b>".date("F j, Y")."</b></td></tr>";
echo "</table></td></tr>";

echo "<tr align=left><td><br>The Nebraska School Activities Association requests that your school host the following tournament.</td></tr>";
echo "<tr align=left><td><table>";
echo "<tr align=left><td width=170><b>Tournament:</b></td><td>$class-$district $type $sportname</td></tr>";
if($dates=="editable")
{
   echo "<tr align=left><td><b>Please Select Date(s):</b></td>";
   echo "<input type=hidden name=\"editdate\" value=\"1\">";
   echo "<td>";
   echo "<select name=mo><option value=''>MM</option>";
   for($i=1;$i<=12;$i++)
   {
      if($i<10) $m="0".$i;
      else $m=$i;
...
if($sport=='pp' || $sport=='sp')
   ...
   $word="Officials";
echo "<tr align=left><td>$word will be assigned by the NSAA office.  $word' names and contact information will be posted on your AD's page.  Other details/instructions will be e-mailed to you at a later date.</td></tr>";

echo "<tr align=left><td>Facilities must provide reasonable accommodation for special needs.</td></tr>";
...
{
   echo "<tr align=left><td><br><br><input type=radio name=accept value='y'>&nbsp;&nbsp;&nbsp;<b>We accept the above agreement to host the $type $class-$district $sportname Tournament</b>";
   echo ".<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
