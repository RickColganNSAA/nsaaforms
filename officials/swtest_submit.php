...
else if($submit=="Submit Test Answers")
{
   ...
   if(GetLevel($session)!=1 && $score<80 && $obtestattempts<3)        //FAILED - CAN RETAKE --  && $offid!='3427')
   {
        ...
        <p>You may <a href=\"swtest.php?session=$session&retake=$resultsid\">Re-Take this Test</a> up to 3 times in order to pass it before the due date has passed.</p>".$end_html;
