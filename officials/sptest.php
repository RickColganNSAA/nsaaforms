...
if(GetLevelJ($session)==1)
{
   echo "<tr align=right><td><a href=\"edit_judge.php?session=$session&offid=$offid\">Return to ".GetJudgeName($offid)."'s Record</a></td></tr>";
}
...
if(GetLevelJ($session)==1)
{
   echo "for <font style=\"color:red\"><b>".GetJudgeName($offid)."</b></font><br>";
}
...
if(GetLevelJ($session)!=1 && PastDue($duedate,0) && $offid!='3427')
{
   //test is past due
