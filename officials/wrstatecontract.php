...
$sql2="SELECT * FROM wrtourndates WHERE lodgingdate='x' AND label = 'State' ORDER BY tourndate";
$result2=mysql_query($sql2);
...
if($edit==1 && $savechanges)
{
   ...
   $sql="UPDATE wrcontracttext SET text1='$text1',text2='$text2',text3='$text3',text4='$text4',text5='$text5',text6='$text6',text7='$text7',text8='$text8' WHERE district='0'";
   ...
   $sql="UPDATE wrdistricts SET dates='$dates' WHERE type='State'";
   $result=mysql_query($sql);
}

if($sample==1) $distid=19;
...
$dates.=$temp[0];
if($row[dates]=='' && $sample==1) $dates="Feb 15, Feb 16, Feb 17, 2008";

//get contract text
$sql="SELECT * FROM wrcontracttext WHERE district='0'";
$result=mysql_query($sql);
$row=mysql_fetch_array($result);
$text1=$row[text1];
$text2=$row[text2];
   ...
   if($level!=1 || ($sample==1 && $lodging==1))
   {
    	 ...
    	 else
	 {
	    if(!($sample==1 && $lodging==1))
	       ...
	       if($sample==1 && $lodging==1)
		  echo "<br><a class=small href=\"wrstatecontract.php?session=$session&sample=1\">Return to Main Contract</a><br><br>";
	       echo "<form method=post action=\"wrstatecontract.php\">";
	       ...
	       echo "<caption align=center><b>NSAA $thisyear State Wrestling Tournament Lodging Confirmation Form:</b></caption>";
	       ...
	       {
	          $num=$i+1;
	          echo "<tr align=left><td><input type=checkbox name=\"date".$num."\" value='x'>&nbsp;";
	       ...
	       echo "<tr align=left><td>Contact Ron Higdon at the NSAA 402-489-0386 with any reservation changes or questions.  The Hotel is not authorized to make changes to existing NSAA reservations.  The NSAA will notify assigned officials where they will be staying in Omaha.</td></tr>";
...
echo "<img src=\"nsaacontract.png\">";
if($sample==1 && $edit!=1)
   echo "<br><a class=small href=\"wrstatecontract.php?session=$session&edit=1\">Edit this Contract</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href=\"wrstatecontract.php?session=$session&sample=1&lodging=1\" class=small>View Lodging Portion of this Contract</a>";
else if($edit==1)
   echo "<br><a class=small href=\"wrstatecontract.php?session=$session&sample=1\">Preview this Contract</a>";
echo "</td></tr>";

if($error==1)
{
   echo "<tr align=center><td><font style=\"color:red\"><b>If you accept this contract, you MUST check Yes or No to the question below pertaining to officials with a son/daughter who might qualify for the State Wrestling Tournament.</b></font></td></tr>";
}
...
if($edit==1)
{
   ...
   echo "<br><font color=red>State Tournament Dates:<br></font>";
   for($i=1;$i<=3;$i++)
   {
