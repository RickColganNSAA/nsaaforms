...
echo "<br>";
echo "<form method=post action=\"hostcontract_trb.php\">";
...
if($edit==1)
   echo "<br><a class=small href=\"hostcontract_trb.php?session=$session&sample=1\">Preview this Contract</a>";
else if($level==1)
   echo "<br><a class=small href=\"hostcontract_trb.php?session=$session&edit=1\">Edit this Contract</a>";
echo "</td></tr>";
