...
echo "<table width=90%>";
echo "<caption><b>Swimming/Diving Rules Examination</b></caption>";
...
$sql0="SELECT category,place FROM swtest_categ ORDER BY place";
...
$sql="SELECT question,place,answer FROM swtest WHERE category='$categid' ORDER BY place";
$result=mysql_query($sql);
$ix=0;
