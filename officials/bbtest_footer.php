...
?>
<form method=post action="bbtest_footer.php" name="footer_form">
...
$sql2="SELECT * FROM bbtest ORDER BY place";
$result2=mysql_query($sql2);
$ix=0; $curcategid=0;
while($row2=mysql_fetch_array($result2))
{
...
$sql="SELECT id,category,place FROM bbtest_categ ORDER BY place";
$result=mysql_query($sql);
