...
echo "<table width=90%>";
echo "<caption><b>NFHS Diving Rules Examination</b></caption>";
...
$sql0="SELECT category,place FROM ditest_categ ORDER BY place";
...
$sql="SELECT question,place,answer FROM ditest WHERE category='$categid' ORDER BY place";
$result=mysql_query($sql);
$ix=0;
