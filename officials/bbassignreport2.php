...
if($print!=1)
{
   echo "<form method=post action=\"bbassignreport2.php\">";
...
if($type=="abc" && $print!=1)
{
   echo "<a class=small href=\"bbassignreport2.php?session=$session&sport=$sport\">View DISTRICT Assignments in Class/District Order</a>&nbsp;&nbsp;";
   echo "<a class=small href=\"bbassignreport2.php?session=$session&sport=$sport&type=state\">View STATE Assignments</a><br>";
}
else if($type=='state' && $print!=1)
{
   echo "<a class=small href=\"bbassignreport2.php?session=$session&sport=$sport\">View DISTRICT Assignments</a>&nbsp;&nbsp;";
}
elseif($print!=1)
{
   echo "<a class=small href=\"bbassignreport2.php?session=$session&sport=$sport&type=abc\">View DISTRICT Assignments in ABC Order</a>&nbsp;&nbsp;";
   echo "<a class=small href=\"bbassignreport2.php?session=$session&sport=$sport&type=state\">View STATE Assignments</a><br>";
}
if($print!=1)
   echo "<a class=small target=new href=\"bbassignreport2.php?session=$session&sport=$sport&type=$type&print=1\">Printer-Friendly Version</a>";
echo "<br><br>";
...
{
   if($gender=='Boys')
      echo "&nbsp;<a class=small href=\"bbassignreport2.php?session=$session&type=state&gender=Girls\">Girls</a>";
   else
      echo "&nbsp;<a class=small href=\"bbassignreport2.php?session=$session&type=state&gender=Boys\">Boys</a>";
}
echo "</b><br>";
echo "<hr></caption>";
...
else if($type=='state')
{
   ...
   $result=mysql_query($sql);
   echo "<tr align=center><td align=left><a class=small href=\"bbassignreport2.php?sport=$sport&sessin=$session&type=state\">Official</a></td>";
   echo "<td><a class=small href=\"bbassignreport2.php?sport=$sport&session=$session&type=state&sort=standby\">Stand-By</a></td>";
   echo "</tr>";
   while($row=mysql_fetch_array($result))
   {
      echo "<tr align=center>";
...
{
   echo "<a class=small href=\"bbassignreport2.php?session=$session&sport=$sport\">View DISTRICT Assignments in Class/District Order</a>&nbsp;&nbsp;";
   echo "<a class=small href=\"bbassignreport2.php?session=$session&sport=$sport&type=state\">View STATE Assignments</a>&nbsp;&nbsp;";
}
else if($type=='state' && $print!=1)
{
   echo "<a class=small href=\"bbassignreport2.php?session=$session&sport=$sport\">View DISTRICT Assignments</a>&nbsp;&nbsp;";
