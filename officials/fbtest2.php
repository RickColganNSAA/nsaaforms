...
$sql="SELECT * FROM $resultstable WHERE offid='$offid' AND datetaken!='' AND datetaken!=0";
...
<iframe style="background-color:#ffffff;margin:0px;width:800px;border:none;height:500px;" src='fbtest2_frame.php?session=<?php echo $session; ?>'></iframe>
<br>
<i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
