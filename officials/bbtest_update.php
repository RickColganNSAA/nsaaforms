...
for($i=0;$i<count($place);$i++)
{
   ...
   $sql="SELECT category FROM bbtest WHERE place='$place[$i]'";
...
top.location.replace("bbtest.php?givenoffid=<?php echo $givenoffid; ?>&session=<?php echo $session; ?>&categid=<?php echo $categid; ?>&home=<?php echo $home; ?>&forcecategid=<?php echo $forcecategid; ?>");
</script>
<?php 
exit();
?>
