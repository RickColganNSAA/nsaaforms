...
$sql="UPDATE test_duedates SET totalques='$totalques',instructions='".addslashes($instructions)."' WHERE test='$sport'";
...
for($i=0;$i<count($quesid);$i++)
{
   ...
   header("Location:edittest.php?session=$session&sport=$sport&saved=1");
   exit();
?>
