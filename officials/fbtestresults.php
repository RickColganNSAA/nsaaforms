...
echo "<table width=90%>";
echo "<caption><b>Football Rules Examination - Part I</b></caption>";
...
$sql0="SELECT category,place FROM fbtest_categ ORDER BY place";
...
$sql="SELECT question,place,answer FROM fbtest WHERE category='$categid' ORDER BY place";
$result=mysql_query($sql);
$ix=0;
