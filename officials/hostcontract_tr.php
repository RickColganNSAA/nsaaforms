...
echo "<br>";
echo "<form method=post action=\"hostcontract_tr.php\">";
...
if($edit==1)
   echo "<br><a class=small href=\"hostcontract_tr.php?session=$session&sample=1\">Preview this Contract</a>";
else
   echo "<br><a class=small href=\"hostcontract_tr.php?session=$session&edit=1\">Edit this Contract</a>";
echo "</td></tr>";
