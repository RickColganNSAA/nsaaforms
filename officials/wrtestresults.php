...
echo "<caption><b>$thisyear Wrestling Rules Examination - Part I</b></caption>";
...
$sql0="SELECT category,place FROM wrtest_categ ORDER BY place";
...
$sql="SELECT question,place,answer FROM wrtest WHERE category='$categid' ORDER BY place";
$result=mysql_query($sql);
$ix=0;
