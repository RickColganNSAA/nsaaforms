...
echo "<table width=90%>";
echo "<caption><b>$thisyear Baseball Rules Examination - Part I</b></caption>";
...
$sql0="SELECT category,place FROM batest_categ ORDER BY place";
...
$sql="SELECT question,place,answer FROM batest WHERE category='$categid' ORDER BY place";
$result=mysql_query($sql);
$ix=0;
