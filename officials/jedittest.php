...
echo "<br>";
echo "<a href=\"jtestreport.php?session=$session&sport=$sport\" class=small>Return to $sportname Online Test Admin</a><br><br>";
...
echo "</td></tr>";
echo "</table></form>";
echo "<a class=small href=\"jtestreport.php?session=$session&sport=$sport\">$sportname Online Test Admin</a>&nbsp;&nbsp;&nbsp;";
