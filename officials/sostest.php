...
$sql="SELECT * FROM test_duedates WHERE test='so'";
$result=mysql_query($sql);
...
if(GetLevel($session)!=1 && PastDue($duedate,0) && $offid!='37622')
{
   //test is past due
...
while($row=mysql_fetch_array($result))
{
   ...
   echo "><td>$place.&nbsp;&nbsp;&nbsp;";
   $row[0]=mb_convert_encoding($row[0], "UTF-8", "iso-8859-1");
   echo $row[0];
   ...
   {  $row2[choicelabel]=mb_convert_encoding($row2[choicelabel], "UTF-8", "iso-8859-1");
