...
$sport='sw'; $sportname=GetSportName($sport);
...
{
   $sql="INSERT INTO $table (school1,school2,offid,dateinitiated) VALUES ('".addslashes($school1)."','".addslashes($school2)."','$offid','".time()."')";
   $result=mysql_query($sql);
}
else
{
   $sql="UPDATE $table SET school1='".addslashes($school1)."',school2='".addslashes($school2)."',dateinitiated='".time()."',datecompleted='0' WHERE offid='$offid'";
   $result=mysql_query($sql);
}
}
$filepath=$row[lockedversion];
