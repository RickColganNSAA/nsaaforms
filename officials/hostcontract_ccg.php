...
'2'";
   ...
   if($dates!="0000-00-00")
   {
      $sql="UPDATE ccgdistricts SET dates='$dates' WHERE type='District'";
      $result=mysql_query($sql);
   }
}
...
echo "<br>";
echo "<form method=post action=\"hostcontract_ccg.php\">";
...
if($edit==1)
   echo "<br><a class=small href=\"hostcontract_ccg.php?session=$session&sample=1\">Preview this Contract</a>";else
   echo "<br><a class=small href=\"hostcontract_ccg.php?session=$session&edit=1\">Edit this Contract</a>";
echo "</td></tr>";
