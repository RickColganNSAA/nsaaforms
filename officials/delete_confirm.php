...
//	delete specified off from the database
...
$sql="SELECT first, last FROM officials WHERE id='$id'";
$result=mysql_query($sql);
$row=mysql_fetch_array($result);

echo $init_html;
if($header!="no") $header1=GetHeader($session);
...
<?php echo " <b>$name</b> ";  ?>
from the database?
<form method="post" action="delete_off.php">
