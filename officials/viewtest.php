...
if($sport=='sos') $sql="SELECT duedate FROM test_duedates WHERE test='so'";
else 
...
if($now<=($duedate+$days4) || $ct==0)	//if not late enough or off did not take this test
{
   //echo $sql;
...
echo "YOUR SCORE: ".number_format(($row3[correct]/$total)*100,0,'.','')."%<br></b></font>";
if($row3[correct]<100)
{
   echo "<br><b>YOU MISSED ";
   if($row3[correct]==99) echo "THIS QUESTION: ";
