...
for($i=0;$i<count($place);$i++)
{
   ...
   $sql="SELECT category FROM sbtest WHERE place='$place[$i]'";
...
top.location.replace("sbtest.php?givenoffid=<?php echo $givenoffid; ?>&session=<?php echo $session; ?>&categid=<?php echo $categid; ?>&forcecategid=<?php echo $forcecategid; ?>&home=<?php echo $home; ?>");
</script>
<?php 
exit();
?>
