...
echo "<table width=90%>";
echo "<caption><b>$thisyear Track & Field Rules Examination - Part I</b></caption>";
...
$sql0="SELECT category,place FROM trtest_categ ORDER BY place";
...
$sql="SELECT question,place,answer FROM trtest WHERE category='$categid' ORDER BY place";
$result=mysql_query($sql);
$ix=0;
