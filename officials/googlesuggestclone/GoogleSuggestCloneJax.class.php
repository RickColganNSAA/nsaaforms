...
require $_SERVER['DOCUMENT_ROOT'].'/nsaaforms/variables.php';
    ...
    { 
                            ...
                            { 
                                ...
                                if (_data.length > 0) { 
                                    for (i = 0; i < _data.length; i++) { 
                                        gsc_addresult(%2\$s, %3\$s, _data[i][0] + ' ' + _data[i][1] + ' (' + _data[i][2] + ')', _data[i][3], i == 0); 
                                    } 
                                    gsc_show(%2\$s); 
                                } 
                            } 
        ...
        { 
            ...
            if (strlen($prefix) > 0) { 
                $query = sprintf("select first, last, city, id 
                                    from %s 
                                    where concat(first,' ',last) like '%s%%' 
                                    limit %d", 
                                 $this->db_table, 
