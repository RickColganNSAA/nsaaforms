...
require $_SERVER['DOCUMENT_ROOT'].'/nsaaforms/variables.php';
    require_once('ajaxac-0.4.1/lib/AjaxACApplication.class.php');
    ...
    class GoogleSuggestCloneJax extends AjaxACApplication
    {
         ...
         */
        var $db_hostname = '$db_host';
        var $db_username = 'nsaa';
        var $db_password = 'scoring';
        var $db_database = '$db_name2';
        ...
        function setup()
        {
            ...
            $this->addJsLib('googlesuggestclone.js');
            ...
            require_once('ajaxac-0.4.1/lib/Widgets/AjaxACWidgetTimer.class.php');
        ...
        /**
         * Handle the getsuggestions HTTP subrequest
         */
        ...
        {
            require_once('ajaxac-0.4.1/lib/Widgets/AjaxACWidgetXMLHttpRequest.class.php');
