...
if($edit==1 && $savechanges)
{
   ...
   $sql="UPDATE sobcontracttext SET text1='$text1',text2='$text2',text3='$text3',text4='$text4',text5='$text5' WHERE district='0'";
   $result=mysql_query($sql);
   //echo $sql."<br>";
}

//get contract text
$sql="SELECT * FROM sobcontracttext WHERE district='0'";
$result=mysql_query($sql);
$row=mysql_fetch_array($result);
...
echo "<br>";
echo "<form method=post action=\"sobstatecontract.php\">";
...
if($edit==1)
   echo "<br><a class=small href=\"sobstatecontract.php?session=$session&sample=1\">Preview this Contract</a>";
else
   echo "<br><a class=small href=\"sobstatecontract.php?session=$session&edit=1\">Edit this Contract</a>";
echo "</td></tr>";
