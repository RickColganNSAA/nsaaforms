...
echo "<tr align=center><td><a href=\"#\" onClick=\"window.opener.document.forms.assignform.hostch.value='$hostch';window.opener.document.forms.assignform.appch.value='$appch';window.opener.document.forms.assignform.hostid.value='$hostid';window.opener.document.forms.assignform.hostschool.value='$hostname2';window.opener.document.forms.assignform.hiddensave.value='Save Changes';window.opener.document.forms.assignform.submit();window.close();\">Click Here to RESET This Field</a></td></tr>";
...
{
   $criteria=array("Fields","Lighted<br>Fields");
   $criteria_sm=array("fieldct","lightfieldct");
}
else if($sport=='ba')
{
...
for($h=0;$h<count($hosts[hostid]);$h++)
{
   ...
   // {
     ...
     echo "<tr align=left><td><a href='' style=\"color:$color\" onClick=\"window.opener.document.forms.assignform.distidd.value='$distid';window.opener.document.forms.assignform.hostchh.value='$hostch';window.opener.document.forms.assignform.appch.value='$appch';window.opener.document.forms.assignform.hostidd.value='$hostid';window.opener.document.forms.assignform.hostschooll.value='$hostname2';window.opener.document.forms.assignform.hiddensave.value='Save Changes';window.opener.document.forms.assignform.submit();window.close();\" class=small>$hostname</a></td>";
