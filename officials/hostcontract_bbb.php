...
if($edit==1 && $savechanges)
{
   ...
   $sql="UPDATE bbbcontracttext SET text1='$text1',text2='$text2',text3='$text3' WHERE district='2'";
   $result=mysql_query($sql);
}

//get contract text
$dist=2;
$sql="SELECT * FROM bbbcontracttext WHERE district='$dist'";
$result=mysql_query($sql);
$row=mysql_fetch_array($result);
...
echo "<form method=post action=\"hostcontract_bbb.php\">
...
if($edit==1)
   echo "<br><a class=small href=\"hostcontract_bbb.php?session=$session&sample=1\">Preview this Contract</a>";
else if($sample==1)
   echO "<br><a class=small href=\"hostcontract_bbb.php?session=$session&edit=1\">Edit this Contract</a>";
echo "</td></tr>";
