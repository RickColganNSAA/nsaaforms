...
echo $init_html."<table width=\"100%\"><tr align=center><td><img src=\"/images/NSAAlogo.gif\">";
if($edit==1 && $level==1)
{
?>
...
if($level==1) echo "<p style='color:#8b0000;'><b>SAMPLE</b></p><p><a href=\"".$sport."showtoad.php?session=$session&edit=1#editbody\">Edit this Page</a></p>";
