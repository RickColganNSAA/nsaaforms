...
if($print!=1)
{
   echo "<form method=post action=\"bbbassignreport2.php\">";
...
if($type=="abc" && $print!=1)
{
   echo "<a class=small href=\"bbbassignreport2.php?session=$session&sport=$sport\">View District Assignments in Class/District Order</a>&nbsp;&nbsp;";
   echo "<a class=small href=\"bbgassignreport2.php?session=$session&sport=$sport\">View GIRLS District Assignments</a>&nbsp;&nbsp;";
   //echo "<a class=small href=\"bbbassignreport2.php?session=$session&sport=$sport&type=state\">View STATE Assignments</a><br>";
   echo "<br>";
}
else if($type=='state' && $print!=1)
{
   echo "<a class=small href=\"bbbassignreport2.php?session=$session&sport=$sport\">View DISTRICT Assignments</a>&nbsp;&nbsp;";
}
elseif($print!=1)
{
   echo "<a class=small href=\"bbbassignreport2.php?session=$session&sport=$sport&type=abc\">View District Assignments in ABC Order</a>&nbsp;&nbsp;";
   echo "<a class=small href=\"bbgassignreport2.php?session=$session&sport=$sport\">View GIRLS District Assignments</a>&nbsp;&nbsp;";
   //echo "<a class=small href=\"bbbassignreport2.php?session=$session&sport=$sport&type=state\">View STATE Assignments</a><br>";
   echo "<br>";
}
if($print!=1)
   echo "<a class=small target=new href=\"bbbassignreport2.php?session=$session&sport=$sport&type=$type&print=1\">Printer-Friendly Version</a>";
echo "<br><br>";
...
else if($type=='state')
{
   ...
   $result=mysql_query($sql);
   echo "<tr align=center><td align=left><a class=small href=\"bbbassignreport2.php?sport=$sport&sessin=$session&type=state\">Official</a></td>";
   echo "<td><a class=small href=\"bbbassignreport2.php?sport=$sport&session=$session&type=state&sort=standby\">Stand-By</a></td>";
   echo "</tr>";
   while($row=mysql_fetch_array($result))
   {
      echo "<tr align=center>";
...
if($type=="abc" && $print!=1)
{
   echo "<a class=small href=\"bbbassignreport2.php?session=$session&sport=$sport\">View District Assignments in Class/District Order</a>&nbsp;&nbsp;";
   echo "<a class=small href=\"bbgassignreport2.php?session=$session&sport=$sport\">View GIRLS District Assignments</a>&nbsp;&nbsp;";
   //echo "<a class=small href=\"bbbassignreport2.php?session=$session&sport=$sport&type=state\">View STATE Assignments</a>&nbsp;&nbsp;";
}
else if($type=='state' && $print!=1)
{
   echo "<a class=small href=\"bbbassignreport2.php?session=$session&sport=$sport\">View DISTRICT Assignments</a>&nbsp;&nbsp;";
