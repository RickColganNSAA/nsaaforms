...
echo "<table width=90%>";
echo "<caption><b>Basketball Rules Examination - Part I</b></caption>";
...
$sql0="SELECT category,place FROM bbtest_categ ORDER BY place";
...
$sql="SELECT question,place,answer FROM bbtest WHERE category='$categid' ORDER BY place";
$result=mysql_query($sql);
$ix=0;
