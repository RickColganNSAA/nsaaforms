...
/*********************************
addmeet_te_b.php
Add Meet for Boys Tennis Results
Created 7/18/08
Author: Ann Gaffigan
*********************************/
...
if($hiddensave || $save)
{
   ...
   $sql="INSERT INTO te_bmeets (meetname,startdate,enddate,meetsite,school) VALUES ('$meetname','$startdate','$enddate','$meetsite','$school2')";
