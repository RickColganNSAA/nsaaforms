...
/*********************************
host_teg.php
District Host Main Menu for Girls Tennis
Created 3/22/10
Author: Ann Gaffigan
*********************************/
...
$sql="SELECT * FROM te_gschool WHERE (";
$sids=split(",",$sids);
...
echo "<tr align=left><td><a href=\"te_gdistresults.php?session=$session\">Enter Results for your District</a></td></tr>";
