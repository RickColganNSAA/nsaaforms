...
echo "</td><td><textarea name=current style=\"width:700px;height:150px;\">$current</textarea></td></tr>";
	//SCHOOL COST
...
echo "</td><td><textarea name=pros style=\"width:700px;height:150px;\">$pros</textarea></td></tr>";
echo "<tr align=left><td colspan=2>";
echo "<p>";
if($errcons==1)
{
...
echo "</td><td><textarea name=cons style=\"width:700px;height:150px;\">$cons</textarea></td></tr>";
