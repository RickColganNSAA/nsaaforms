...
{
   echo $init_html;
   echo "<table><tr align=center><th><br><br>ERROR: $type $class-$district is NOT a Girls Basketball District.<br><br>";
   if($level==1)
...
if($hiddenupdate || $submitted==1) //submit report AND/OR show submitted report
{
   ...
   echo "<table width=700 class=nine><caption><b>NSAA Girls Basketball Financial Report</b><hr></caption>";
   ...
   if(!$disttimesid)	//HOST ALLOWANCE FOR NON CLASS A BASKETBALL ONLY
   {
      ...
      echo "<td align=right><b>Host School Allowance&nbsp;&nbsp;#4 $space $</b></td><td align=right>".number_format($row[hostgiven],2,'.','')."</td></tr>";
   }
   ...
   echo "</tr>";
   echo "</table></td></tr>";
   echo "<tr align=left valign=top><td><b>Balance for Bonus</b> (#7 minus #8) To be distributed as specified below.<br>";
   if($row[hostpart]=='x')
   {
...
/*    echo "<table width=450 border=1 bordercolor=\"red\" cellspacing=0 cellpadding=5><tr align=left><td class=nine>";
   ...
   echo "GB 602-3 <u>$space $space $space $space $space $space $space $space $space $space</u><br><br>";
...
echo "<table style=\"max-width:960px;\" cellspacing=0 cellpadding=6 class=nine><caption><h2>NSAA ".strtoupper($type)." GIRLS BASKETBALL TOURNAMENT FINANCIAL REPORT</h2>";
...
if($type=="District Final")
{
   ...
   $tab=9;
   echo "<td align=center bgcolor=>$<input type=text tabindexx=$tab class=tiny size=7 name=\"hostgiven\" id=\"hostgiven\" value=\"".number_format(50,2,'.','')."\" readOnly=true></td></tr>";
   $num=5;
}
else if(!$disttimesid)    //HOST ALLOWANCE FOR NON CLASS A BASKETBALL ONLY
{
   ...
   echo "<td align=right><b>6. Host School Allowance&nbsp;&nbsp;</b></td>";
   $tab=9;
   echo "<td align=center bgcolor=>$<input type=text tabindexx=$tab class=tiny size=7 name=\"hostgiven\" id=\"hostgiven\" value=\"".number_format($hostgiven,2,'.','')."\" onblur=\"Finance3.Calculate(this.id,this.value);\"></td></tr>";
   $num=5;
}
else 
{
...
echO "<tr><td align=left><b>Balance</b> (Gross Receipts #1, minus lines #2 through #6)</td>";
//echo "<td align=right><b>Balance&nbsp;&nbsp;#$num</b></td>";
...
echo "<br />
	...
	<tr bgcolor='yellow'><td align=right>Number of GAMES Broadcasted:</td><td align=left><input type=text size=2 tabindex=125 name=\"localmedia_bcasts\" value=\"$localmedia_bcasts\" id=\"localmedia_bcasts\" onBlur=\"CalculateBcasts();\"></td></tr>
	...
	echo "<tr bgcolor='yellow'><td align=right>Number of GAMES Webcasted:</td><td align=left><input type=text size=2 tabindex=126 name=\"othermedia_wcasts\" value=\"$othermedia_wcasts\" id=\"othermedia_wcasts\" onBlur=\"CalculateBcasts();\"></td></tr>";
	...
	echo "<tr bgcolor='yellow'><td align=right>Number of GAMES Telecasted (TV):</td><td align=left><input type=text size=2 tabindex=127  name=\"othermedia_tcasts\" value=\"$othermedia_tcasts\" id=\"othermedia_tcasts\" onBlur=\"CalculateBcasts();\"></td></tr>";
