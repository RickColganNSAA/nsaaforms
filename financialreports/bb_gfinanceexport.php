...
for($file=0;$file<count($bbfiles);$file++)
{
    ...
    $sql="SELECT t1.*,t2.id AS distid,t2.class,t2.district,t2.hostschool,t2.site FROM finance_bb_g AS t1,$officialsdb.bbgdistricts AS t2 WHERE t2.class='$class' AND t1.distid=t2.id AND t2.type='$type' ORDER BY t2.district";
    ...
    while($row=mysql_fetch_array($result))
    {
	  ...
	  $tourn[visperc][$tid]="75%";
       ...
       $sql2="SELECT * FROM finance_bb_g_exp WHERE distid='$distid' ORDER BY school";
