...
$attachment=array();
///$attachment[]='2007JudgesLetter.htm';


SendMail('dd','saif@primtechs.com', 'saif@primtechs.com', 'Gabbar sing' ,' with Nsaaform  attachment '.date("F j, Y, H:i:s ").' unix time=' .time(), 'Amazon SES SMTP interface using the PHPMa', 'Amazon SES SMTP interface using the PHPMa'  ,$attachment );
