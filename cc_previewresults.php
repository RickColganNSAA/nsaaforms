...
if($sport=="cc_g") { $gender="Girls"; $submitvar="submitted_g"; $schooltbl="ccgschool"; $sport2="ccg"; }
else { $gender="Boys"; $submitvar="submitted_b"; $schooltbl="ccbschool"; $sport2="ccb"; }
$html.="<b>".date("Y")." $gender Class $class District Results</b><br>";
$html.="</caption><tr align=left><td>";

$sql="SELECT DISTINCT t1.district_id,t2.district,t2.site,t2.hostschool FROM ".$sport."_state_indy AS t1, $db_name2.ccdistricts AS t2 WHERE t1.district_id=t2.id AND t2.class='$class' AND t2.$submitvar='x' ORDER BY t2.district";
