...
if($print!=1)
{
   ...
   //echo "<a href=\"teamlist_g.php?session=$session&school_ch=$school&print=1\" target=new>Click Here for your Team's District Roster</a><br>";
...
if($print==1)
{
   ...
   citgf_exec("/usr/local/bin/php teamlist_g.php session=$session school_ch=\"$school_ch\" > output.txt 2>&1");
   $teamlist="tr/teamlists/".$sch."girlsdistroster";
?>
</table>
<table>
