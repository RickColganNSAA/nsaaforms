<?php
//teamlist_b.php: list of students eligible to participate in track for school
...
$info.="<caption><b>$team Boys Track & Field District Roster:<br /></b>as of $date<br><br></caption>";
$csv="$team Boys Track & Field District Roster:\r\n";
$csv.=",Name (Grade)\r\n";
$info.="<tr align=center><th class=smaller colspan=2>Name (Grade)</th></tr>";
//get boys from this school (or co-op students) participating in track
