...
if(!ValidUser($session) )
{
 ...
 $sql="SELECT * FROM anthem ORDER BY id";
...
<a href="1rename.php?session=<?php echo $session;?>"><button type="button" name=""onclick="return confirm('Are you sure that you want to delete all data from below list?');" value="delete">CLEAR LIST for new year</button><a>
...
<a href="anthem_edit.php?session=<?php echo $session;?>">Edit Dates</a><br><br>
