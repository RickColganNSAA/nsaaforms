<?php
/* SPEECH RULES MEETING FOR COACHES */
...
if($passcode!='')
{
   $sql="SELECT * FROM $db_name2.logins_j WHERE passcode='$passcode'";
   $result=mysql_query($sql);
   if(mysql_num_rows($result)==0)       //NOT VALID
   {
      echo $init_html;
      echo GetHeader($session);
      echo "<br><br><div style='width:300px;' class=error>ERROR:<br><br>You have entered an invalid judge's passcode.<br><br>Please <a href=\"javascript:history.go(-1);\">Go Back and Try Again</a>.</div><br><br>";
      echo $end_html;
      exit();
   }
