...
else	//show summary of school's current MU entry:
{
   ...
   if(($level!=1 && $school!="Test's School" && PastDue($duedate,0)) || $submitted!='')	//school has submitted this form
   {
   ...
   else
   {
      ...
      echo "<br><font style=\"font-size:9pt;\"><font style=\"color:blue\">You must complete and submit this form to the NSAA by midnight on <b>March 20, $year2.</font>";
   ...
   echo "</caption>";
   echo "<form method=post action=\"edit_mu.php#top\">";
   echo "<input type=hidden name=session value=\"$session\">";
   echo "<input type=hidden name=school_ch value=\"$school_ch\">";
   echo "<tr align=center><td><hr><table border=1 bordercolor=#000000 cellspacing=0 cellpadding=3>";
   ...
   echo "<iframe name=\"contentframe\" id=\"contentframe\" src=\"edit_categ.php?school_ch=$school_ch&session=$session\" width=\"100%\" height=\"800\" frameborder=0></iframe>";
   echo "</td></tr>";
}
echo "</table>";
?>
